...
export class Backend implements backendInterface {
    ...
    async fetchAndCacheCoinGeckoPrices(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchAndCacheCoinGeckoPrices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPatternScores(): Promise<Array<PatternEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPatternScores();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCoinGeckoPrices(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getCoinGeckoPrices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPatternScores(arg0: string): Promise<Array<PatternEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPatternScores(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
