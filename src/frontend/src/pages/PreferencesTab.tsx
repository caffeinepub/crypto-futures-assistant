        ...
        <section className="space-y-3 pt-2 border-t border-white/5">
          ...
          <div className="rounded-xl border border-white/10 bg-surface p-3 space-y-2">
            ...
            <div className="flex justify-between text-xs">
              ...
              <span className="font-mono text-neon-purple">
                {new Set(log.map((e) => e.symbol)).size}
              </span>
            </div>
          </div>
          ...
          {resetDone ? (
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <button
                  type="button"
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-neon-red/40 bg-neon-red/10 text-neon-red text-sm font-semibold hover:bg-neon-red/20 transition-colors w-full justify-center"
                >
                  <Trash2 size={14} />
              ...
              <AlertDialogContent className="bg-surface border-white/20">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription className="text-muted-foreground">
                    This will permanently delete all {totalObservations} local
                    pattern observations from your device. Global learning data
                    on the blockchain is not affected.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
        ...
        <section className="space-y-3 pt-2 border-t border-white/5">
          ...
          <AuthGate message="Connect with Internet Identity to manage your Binance API keys">
            <div className="space-y-3">
              <div className="text-[11px] text-muted-foreground">
                Keys are stored only on your device (localStorage). Never sent
                to any server.
              </div>
        ...
        <section className="space-y-3 pt-2 border-t border-white/5">
          ...
          <div className="flex items-center justify-between px-3 py-3 rounded-xl border border-white/10 bg-surface">
            <div>
              ...
              <div className="text-[10px] text-muted-foreground">
                Visual alerts for significant P&L changes
              </div>
            </div>
            <button
              type="button"
